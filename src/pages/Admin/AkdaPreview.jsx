...
const AkdaInvoicePreview = ({ invoice: propInvoice }) => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(invoiceRef.current, {
        scale: 2, // Reduced scale for better quality while maintaining performance
        useCORS: true,
        logging: false,
        backgroundColor: "#ffffff",
        windowWidth: 1200, // Set a fixed width for consistent rendering
        windowHeight: 1600, // Set a fixed height for consistent rendering
      });
      ...
      // Generate filename with invoice ID and date
      const fileName = `invoice_${invoice._id}_${format(
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 shadow-md print:shadow-none">
      <div className="print:hidden mb-4 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm rounded disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {downloading ? (
      ...
      <div ref={invoiceRef} className="print:shadow-none">
        <div className="border-b border-gray-200 pb-6 mb-6 print:border-none">
          <div className="flex justify-between items-start">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-800">Akda</h2>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <p className="font-medium">Akda Invoice System</p>
            <p className="text-sm text-gray-600">123 Business Road, City</p>
            <p className="text-sm text-gray-600">Phone: +123-456-7890</p>
            <p className="text-sm text-gray-600">Email: info@akdainvoice.com</p>
          </div>
          <div>
